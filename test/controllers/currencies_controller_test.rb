...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { currency_name: @currency.currency_name, iso_code: @currency.iso_code, sorder: @currency.sorder, symbol: @currency.symbol } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { currency_name: @currency.currency_name, iso_code: @currency.iso_code, sorder: @currency.sorder, symbol: @currency.symbol } }
